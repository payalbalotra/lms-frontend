...
export const mockSops: Procedure[] = [
  {
    ...
    category: { id: 'cat-prep', slug: 'prep', nameEn: 'Prep', nameEs: 'Preparación', isArchived: false },
    status: 'published',
  ...
  },
  {
    ...
    category: { id: 'cat-fryer', slug: 'fryer', nameEn: 'Fryer', nameEs: 'Freidora', isArchived: false },
    status: 'published',
    stationScope: { mode: 'all', stationIds: [] },
    bodyEn: fryerOilBody,
    bodyEs: fryerOilBody,
  ...
  },
  {
    ...
    category: { id: 'cat-knives', slug: 'knives', nameEn: 'Knives', nameEs: 'Cuchillos', isArchived: false },
    status: 'published',
    stationScope: { mode: 'all', stationIds: [] },
...
export const mockTrainingAssignments: TrainingAssignment[] = [
  ...
  },
  {
    ...
    status: 'in_progress',
    completedStepIds: ['hw-s1', 'hw-s2', 'hw-s3'],
    quizPassedAt: null,
    acknowledgedAt: null,
  },
  {
