 ...
 *
 * Each step is said once, here, and drawn twice: as a line in the overview and
 * as a screen in cook mode. The line carries the instruction and anything about
 * safety; the screen adds the photo at full size and the note on why.
 */
...
export type RecipeStep = {
  ...
  discardAt?: boolean;
  /** A clock the step starts, which keeps running while the cook moves on. */
...
export const STEPS: RecipeStep[] = [
  /* --- Set up ------------------------------------------------------------ */
  {
    ...
    timer: { seconds: 20, label: 'Hand wash' },
  },
  {
    n: 2,
  ...
  /* --- Store and check --------------------------------------------------- */
  {
    ...
    timer: { seconds: 1800, label: 'Walk-in' },
    media: {
      kind: 'photo',
      src: 'step-8-film.jpg',
